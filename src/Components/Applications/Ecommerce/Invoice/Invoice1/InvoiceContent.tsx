import { AmountDus, BilledTo, InvoiceDate, InvoiceNumber, inventoMatchettVandelayGroupLTD, UnitedStateTitleText } from "@/Constant";
        ...
        <tbody>
          <tr>
            <td>
              ...
              <h6>{inventoMatchettVandelayGroupLTD}</h6>
            </td>
            <td>
