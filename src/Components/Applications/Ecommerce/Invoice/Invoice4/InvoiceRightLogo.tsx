...
const InvoiceRightLogo = () => {
  return (
    <td>
      ...
      <span style={{ display: "block", lineHeight: "1.5", fontSize: 16, fontWeight: 400, opacity: "0.8" }}>{Email} : invento@themesforest.com</span>
      <span style={{ display: "block", lineHeight: "1.5", fontSize: 16, fontWeight: 400, opacity: "0.8"}}>{Website}: www.inventothemes.com</span>
    </td>
  );
};
