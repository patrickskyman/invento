  ...
  return (
    <div className="sidebar-body">
      <div className="product-upload">
        <p>Screenshot Image or proof of work <span className="txt-danger"> *</span> </p>
        <Dropzone onChange={(files)=>updateFiles(files)} value={files} maxFiles={1} header={false} footer={false} minHeight="80px" name="fileName">
          ...
          {files.length === 0 && (
            <div className="dz-message needsclick">
              ...
              <h5>Drag your proof of file here, or
                <Link className="txt-primary" href={Href}>&nbsp;browse</Link>
              </h5>
