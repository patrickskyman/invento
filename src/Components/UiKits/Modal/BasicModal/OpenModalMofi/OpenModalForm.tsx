...
import { EmailAddress, EnterYourFirstName, EnterYourLastName, FirstName, LastName, inventoEmail, SignUp, TermsAndCondition } from "@/Constant";
            ...
            <Row>
              ...
              <Col md="12">
                <FormGroup>
                  ...
                  <Field type="text" name="email" className={`form-control ${formSubmit && `${errors.lastname ? "is-valid" : "is-invalid"}`}`} placeholder={inventoEmail} />
                </FormGroup>
              </Col>
              <Col md="12">
                <FormGroup check>
