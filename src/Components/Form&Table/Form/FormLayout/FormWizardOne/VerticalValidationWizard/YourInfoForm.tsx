...
import { AgreeToTermsAndConditions, inventoMail, ContactNumber, Email, EnterFirstName, EnterLastName, EnterNumber, FirstName, LastName, Next, State, ZipCode } from "@/Constant";
      ...
      <Row>
        ...
        <Col xxl="4" sm="6">
          <FormGroup>
            ...
            <Input name="email" type="email" placeholder={inventoMail} value={email} onChange={getUserData} />
          </FormGroup>
        </Col>
        <Col xxl="5" sm="6">
          <FormGroup>
