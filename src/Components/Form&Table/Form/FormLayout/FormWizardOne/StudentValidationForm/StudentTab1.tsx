...
import { inventoMail, ConfirmPassword, Email, EnterConfirmPassword, EnterPassword, EnterYourName, Name, Password } from "@/Constant";
  ...
  return (
    <Row className="g-3">
      ...
      <Col sm="6">
        ...
        <Input name="email" onChange={getUserData} value={email} type="email" placeholder={inventoMail} />
      </Col>
      <Col xs="12">
